...
bool isfound;
int x, n, i, op_search, id_search, op_update, new_id, new_qty, op_delete;
int id[100];
std::string name[100];
float price[100];
float new_price;
...
void Delete()
{
    ...
    std::cout << "\t1.Delete product by id\n";
    std::cout << "\t2.Delete product by name\n";
    delete01:
    std::cout << "\tChoose the option: ";
    std::cin >> op_delete;
    switch (op_delete)
    ...
    case 2:
    deleteB:
        std::cout << "\tEnter name of Product to delete: ";
        std::cin >> name_search;
        isfound = 0;
        for (i = 0; i < n; i++)
        {
